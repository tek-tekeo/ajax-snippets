...
if ( !defined( 'ABSPATH' ) ) exit; ?>
  ...
  $sql = "SELECT DISTINCT T.*, sum(L.id) as is_checked FROM `wp_ajax_snippets_tag` as T LEFT OUTER JOIN `wp_ajax_snippets_tag_link` as L ON T.id=L.tag_id AND L.item_id=".$id." group by T.id order by T.id asc";
