<template>
  <div>
    <v-text-field :label="label" :value="value" :type="valueType" @input="changeValue" hide-details="auto"
      :rules="rules" :prepend-icon="prependIcon" :readonly="readonly" :clearable="clearable"></v-text-field>
  </div>
</template>
